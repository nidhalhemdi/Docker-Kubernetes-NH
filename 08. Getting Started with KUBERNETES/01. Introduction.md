...
* For production you’ll need to learn networking (Ingress), storage classes, RBAC, monitoring (Prometheus), logging, and CI/CD integration. Those come later in the course.
