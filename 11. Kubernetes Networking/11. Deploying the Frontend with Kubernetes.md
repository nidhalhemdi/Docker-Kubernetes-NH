...
Deploy the React frontend application on Kubernetes so users can access it publicly—just like the backend services.

---

# 🚀 **2. Preparing the Frontend for Deployment**
...
# 🧩 **3. Creating the Frontend Deployment**
...
* remove environment variables (frontend doesn’t need them)

This produces a **simple deployment** that runs the NGINX server.

---

# 🌐 **4. Exposing the Frontend to the World**
...
* In real cloud deployments, the IP is usually stable or mapped to a domain—so hardcoding is somewhat acceptable.
* But the lecturer is about to show a **better solution** to avoid hardcoding service addresses.

This will be the “trick” introduced in the next lecture.
