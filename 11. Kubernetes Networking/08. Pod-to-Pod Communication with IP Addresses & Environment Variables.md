...
Enable communication between two different Pods (Users API → Auth API) **using the Auth Service**, and learn:
...
# 🔹 **1. Services Provide Stable Internal IPs**
...
✔ Login and signup still work → communication succeeded.
...
# 🔹 **2. Kubernetes Auto-Generates Environment Variables**
...
Its value = **the service’s ClusterIP**

---

# 🔹 **3. Using the Auto-Generated Variable in Code**
...
→ so you can test both approaches.

---

# 🔹 **4. Ensuring Docker Compose Still Works**
...
# ✔️ **6. Final Verification**

Send both:

* **POST /signup** → uses manually set IP
* **POST /login** → uses auto-generated env var

Both requests work → proof:

✔ Service IP is correct
✔ Auto-generated env variable resolves to the service IP
✔ Pod-to-Pod communication is functioning
